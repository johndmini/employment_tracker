...
export default function TargetEmployee(props) {
  ...
  const updateEmployee = async (id, newUpdates) => {
    try {
      const response = await axios.put(
        `https://johnd-employment-tracker.herokuapp.com/employees/targetemployee/${id}`,
        newUpdates
      );
  ...
  const deleteEmployee = async (id) => {
    try {
      const response = await axios.delete(`https://johnd-employment-tracker.herokuapp.com/employees/targetemployee/${id}`);
      setEmployees((prevState) =>
